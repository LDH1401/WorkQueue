...
async function seed() {
  ...
  const tasks = [
    ...
    { title: 'Kiểm thử luồng đặt hàng', status: 'in_progress', priority: 'high', project: web._id, tags: ['qa'], dueDate: days(1) },
    ...
    { title: 'Nghe podcast BBC 6 Minute English', status: 'in_progress', priority: 'medium', project: app._id, tags: ['listening'], dueDate: days(4) },
    { title: 'Đóng tiền điện nước', status: 'todo', priority: 'low', project: null, tags: ['cá-nhân'], dueDate: days(10) },
    { title: 'Đặt lịch khám sức khoẻ định kỳ', status: 'todo', priority: 'urgent', project: null, tags: ['sức-khoẻ'], dueDate: days(0) },
  ];
